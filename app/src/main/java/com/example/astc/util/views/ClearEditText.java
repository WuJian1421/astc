 ...
 * @author
 */
public final class ClearEditText extends RegexEditText implements View.OnTouchListener,
    ...
    protected void initialize(Context context, AttributeSet attrs) {
        ...
        mClearDrawable = DrawableCompat.wrap(ContextCompat.getDrawable(context, R.mipmap.ic_input_delete));
